...
fn add_triplet(Triplet(xr, xg, xb): Triplet, Triplet(yr, yg, yb): Triplet) -> Triplet {
    Triplet(xr + yr, xg + yg, xb + yb)
}
...
fn triplet_possible(red: u32, green: u32, blue: u32, Triplet(r, g, b): &Triplet) -> bool {
...
fn minimum_triplet_power(triplets: &Vec<Triplet>) -> u32 {
    ...
    for Triplet(r, g, b) in triplets.iter() {
